...
public class Practice01LinearGradientView extends View {
...

    {
        ...
        paint.setShader(new LinearGradient(200, 200, 400, 400, Color.parseColor("#E91E63"),
                Color.parseColor("#2196F3"), Shader.TileMode.REPEAT)); // TileMode 一共有 3 个值可选： CLAMP, MIRROR(镜像) 和 REPEAT(重复)
    }
